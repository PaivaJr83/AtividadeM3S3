...
class GerenciadorPecas:
    ...
    def cadastrar_peca(self, nome, fabricante, valor):
    ...
    def consultar_todas_pecas(self):
        return self.pecas

    def consultar_peca_por_codigo(self, codigo):
        for peca in self.pecas:
            if peca['codigo'] == codigo:
                return peca
        return None

    def consultar_pecas_por_fabricante(self, fabricante):
        pecas_filtradas = []
        for peca in self.pecas:
            if peca['fabricante'] == fabricante:
